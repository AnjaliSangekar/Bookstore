...
import { CartItem } from "./addcartProduct"; 
...
import { addToOrders, emptyCart } from "../BookStoreItem/cartProduct";
...
export const Cart = () => {
    ...
    return (
        ...
        
        {
            ...
            <div>
                <img src="./images/empty-cart.png" alt="empty-cart" className="empty-cart-img" ></img>
            </div>
            :          
