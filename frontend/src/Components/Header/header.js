...
import "../BooksItem/books.css";
import { addToOrders ,addToSearch, resetTotal } from "../BookStoreItem/cartProduct";
...
export const Header = () => {
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            const url = "http://localhost:3000/search?item=" + item;
    ...
    return (
        <div className="navbar-container">
            <div className="logo-div">
                <img src="./book.webp" className="logo-img" />
                <Link to="/" className="nav-links">BookStore</Link>
                ...
                <form onSubmit={(event) => handleSubmit(event)} className="search-form">
                    <div className="search-div">
                        <div className="search-input-div">
                            <input type="text" className="input-tag" placeholder="Search Your Favourite Book..." />
                        </div>
